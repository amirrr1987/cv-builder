<template>
    <div id="printMe" class="overflow-y-scroll" :class="`font-${personalStore.$state.profile.font}`">
        <main class="grid grid-cols-12">
            <section class=" col-span-3 grid grid-rows-silde gap-y-5  py-3 px-5"
                :class="`bg-${personalStore.$state.profile.theme}-50`">
                <div class="">
                    ...
                    <div class="text-center ">
                        <div class="font-bold capitalize text-lg mt-3"
                            :class="`text-${personalStore.$state.profile.theme}-900`">{{ fullName }}</div>
                        <div class="capitalize text-base" :class="`text-${personalStore.$state.profile.theme}-900`">{{
                ...
                <hr>
                <div>
                    <div class="capitalize font-bold" :class="`text-${personalStore.$state.profile.theme}-900`"> {{
                        $t('aboutMe') }}</div>
                ...
                <div class="grid auto-rows-max gap-y-3">
                    <div class="grid auto-rows-max gap-y-3">
                        <div class="capitalize font-bold text-lg"
                            :class="`text-${personalStore.$state.profile.theme}-900`">{{ $t('softwareKnowledge') }}
                        </div>
                        <template v-for="item in personalStore.$state.profile.softwareKnowledges">
                            ...
                            <div class="grid grid-cols-[max-content,1fr] gap-x-2 gap-y-1 px-3 items-center">
                                ...
                                <div class="text-sm text-dark-50-light">Flex Box, Grid Layout, Animation, BEM, SCSS</div>
                                <div class="font-medium text-primary-dark">CSS Framework:</div>
                                <div class="text-sm text-dark-50-light">Bootstrap, TailwindCSS, Bulma</div>
                                <div class="font-medium text-primary-dark">javaScript</div>
                                <div class="text-sm text-dark-50-light">Bom, Dom, Axios, ES6</div>
                                <div class="font-medium text-primary-dark">Vue.js</div>
                                <div class="text-sm text-dark-50-light">Vue Option API,Vue Composition API, Vue-Router,
                                    Vuex
                                </div>
                                <div class="font-medium text-primary-dark">Vue.js Framework:</div>
                                <div class="text-sm text-dark-50-light">Vuetify, Ant Desgin, BootstrapVue</div>
                                <div class="font-medium text-primary-dark">Protocol:</div>
                                <div class="text-sm text-dark-50-light">REST</div>
                                <div class="font-medium text-primary-dark">Control Version:</div>
                                <div class="text-sm text-dark-50-light">Git, Git Flow</div> -->
                            </div>
                        </template>
                        <!-- <div class="grid grid-cols-[max-content,1fr] gap-x-2 gap-y-1 px-3 items-center">
                            <div class="font-medium text-primary-dark">Basic:</div>
                            <div class="text-sm text-dark-50-light">HTML, CSS, javaScript </div>
                            <div class="font-medium text-primary-dark">CSS:</div>
                            <div class="text-sm text-dark-50-light">Flex Box, Grid Layout, Animation, BEM, SCSS</div>
                            <div class="font-medium text-primary-dark">CSS Framework:</div>
                            <div class="text-sm text-dark-50-light">Bootstrap, TailwindCSS, Bulma</div>
                            ...
                            <div class="text-sm text-dark-50-light">Bom, Dom, Axios, ES6</div>
                            <div class="font-medium text-primary-dark">Vue.js</div>
                            <div class="text-sm text-dark-50-light">Vue Option API,Vue Composition API, Vue-Router, Vuex
                            </div>
                            <div class="font-medium text-primary-dark">Vue.js Framework:</div>
                            <div class="text-sm text-dark-50-light">Vuetify, Ant Desgin, BootstrapVue</div>
                            <div class="font-medium text-primary-dark">Protocol:</div>
                    ...
                    <div class="capitalize font-bold text-lg flex justify-between"
                        :class="`text-${personalStore.$state.profile.theme}-900`">
