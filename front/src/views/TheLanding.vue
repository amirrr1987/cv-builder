            ...
            <div class="container mx-auto px-3">
                <div class="flex flex-col items-center gap-5">
                    <h3
                        ...
                        ResumeIT in technologies
                    </h3>
                    <p class="text-lg font-normal text-gray-500 dark:text-gray-400 lg:text-center lg:text-xl lg:px-64">
                        You can now also get started with open-source component libraries built for frameworks such as
                        React, Vue.js, Svelte and Angular.
                    </p>
        ...
        <section class="py-20">
            <div class="container mx-auto px-3">
                ...
                <div class="grid grid-cols-6">
                    <div class="col-start-1 col-end-7 grid grid-cols-3 gap-5">
                        <div>
                            <Icon icon="icon-park-outline:code" class="text-6xl mx-auto mb-5 text-[#3b5998]" />
                ...
                <div class="gap-16 items-center lg:grid lg:grid-cols-2">
                    <div class="font-light text-gray-500 sm:text-lg dark:text-gray-400">
                        ...
                        <p class="mb-4">We are strategists, designers and developers. Innovators and problem solvers.
                            ...
                            need. Small enough to be simple and quick, but big enough to deliver the scope you want at
                            the
                            pace you need.</p>
            ...
            <div class="container mx-auto px-3">
                ...
                <div class="grid md:grid-cols-3 gap-20">
                    ...
                    <figure>
                        ...
                        <figcaption class="text-center text-gray-500 sm:text-center">
                            <h3 class="mb-2 text-xl font-bold text-gray-800 dark:text-white">Business Automation</h3>
                    ...
                    <figure>
                        ...
                        <figcaption class="text-center text-gray-500 sm:text-center">
                            <h3 class="mb-2 text-xl font-bold text-gray-800 dark:text-white">Finance</h3>
                    ...
                    <figure>
                        ...
                        <figcaption class="text-center text-gray-500 sm:text-center">
                            <h3 class="mb-2 text-xl font-bold text-gray-800 dark:text-white">Enterprise Design</h3>
                    ...
                    <figure>
                        ...
                        <figcaption class="text-center text-gray-500 sm:text-center">
                            <h3 class="mb-2 text-xl font-bold text-gray-800 dark:text-white">Operations</h3>
        ...
        <section class="py-20">
            <div class="container mx-auto px-3">
                <h2 class="text-center mb-4 text-4xl tracking-tight font-extrabold text-gray-900 dark:text-white">Our
                    Team</h2>
                <p class="text-center font-light text-gray-500 lg:mb-16 sm:text-xl dark:text-gray-400">Explore the whole
                ...
                <div class="md:flex md:justify-between">
                    <div class="mb-6 md:mb-0">
                        <a href="https://flowbite.com/" class="flex items-center">
                            ...
                            <span
                                class="self-center text-2xl font-semibold whitespace-nowrap dark:text-white">ResumeIT</span>
                        </a>
                    </div>
        ...
        <div class="py-3">
            <div class="container mx-auto px-3">
                <div class="grid sm:grid-cols-3 gap-3">
                    <span class="text-sm text-gray-500 text-center sm:text-left">© 2022 <a href="https://flowbite.com/"
