      ...
      <div class="flex justify-between items-center">
        ...
        <div class="flex items-center gap-x-4">
          ...
          <Dropdown>
            ...
            <template #overlay>
              <Menu>
                ...
                <MenuItem>
                  <div class="flex gap-x-3 items-center">Persian</div>
                </MenuItem>
              </Menu>
            </template>
          </Dropdown>
          <Select v-model:value="theme.font" :class="`font-${theme.font}`">
            ...
            <SelectOption value="roboto" class="font-roboto"
              >Roboto</SelectOption
            >
            <SelectOption value="spaceMono" class="font-spaceMono"
              >Space Mono</SelectOption
            >
            <SelectOption value="calibri" class="font-calibri"
              >Calibri</SelectOption
            >
            <SelectOption value="helvetica" class="font-helvetica"
              >Helvetica</SelectOption
            >
            <SelectOption value="georgia" class="font-georgia"
              >Georgia</SelectOption
            >
          ...
          <Dropdown>
            ...
            <template #overlay>
              ...
              >
                ...
                <RadioButton
                  value="amber"
                  class="!bg-amber-500 !w-6 !h-6 !p-0"
                />
                <RadioButton value="lime" class="!bg-lime-500 !w-6 !h-6 !p-0" />
                <RadioButton
                  value="green"
                  class="!bg-green-500 !w-6 !h-6 !p-0"
                />
                <RadioButton
                  value="emerald"
                ...
                <RadioButton
                  value="slate"
                  class="!bg-slate-500 !w-6 !h-6 !p-0"
                />
                <RadioButton
                  value="stone"
                  class="!bg-stone-500 !w-6 !h-6 !p-0"
                />
                <RadioButton
                  value="neutral"
                ...
                <RadioButton
                  value="light"
                  class="!bg-light-500 !w-6 !h-6 !p-0"
                />
